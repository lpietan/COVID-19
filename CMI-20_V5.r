...
## Uncomment out lines below for testing with the allele variable factored (as categorical variables)
...
## k = 20 selects the top 20 most infomative variables per intermidiate dataset. This variable can be tuned. If tuning this variable make sure to change below 
## code to match. 
...
## Add CMI selected variable to final dataset
CMI_dataframe <- cbind(CMI_dataframe, f)
} else if (length(i) < 20 & length(i) > 0){
