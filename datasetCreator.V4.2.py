...
## How this file should be used on the command line. 
## bcftools view -h example.vcf.gz | grep 'CSQ' > temp
## python datasetCreator.V4.2.py "example.vcf.gz" "targets_file.txt" "example_ML-dataset_V4.2.csv"
## rm temp
...
for variant in my_parser:
	...
	## For tracking progress in log file 
